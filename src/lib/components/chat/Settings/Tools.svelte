				...
				<div class="pr-1.5">
					...
					<div class="my-1.5">
						<div class="text-xs text-gray-500">
							...
							<br />
							{$i18n.t(
								'CORS must be properly configured by the provider to allow requests from LOOP Chat.'
							)}
						</div>
					</div>

					<div class=" text-xs text-gray-600 dark:text-gray-300 mb-2">
						<a class="underline" href="https://github.com/DFveloper/openapi-servers" target="_blank"
